...
char message[32] = "Bike1";
char ble_uuid[64] = "AE1DA8A3-9345-516F-BF13-46F14385C3AA";
char en_code[2] = "en";
...
#define LAB2_SERVICE_UUID BT_UUID_128_ENCODE(0xAE1DA8A3, 0x9345, 0x516F, 0xBF13, 0x46F14385C3AA)
